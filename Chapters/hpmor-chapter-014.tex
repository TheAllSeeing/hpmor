...
\emph{You're giving me a \mentalscream{time machine} to treat my \mentalscream{sleep disorder}.}

\emph{\mentalscream{You're \secondemph{giving me a time machine} in order to
\secondemph{treat my sleep disorder}.}}
...
weigh 41 kilograms and that the resulting blast would leave \mentalscream{a giant smoking
crater where there used to be scotland?}}

"Excuse me," Harry managed to say, "but this sounds really really \emph{really
\shout{really dangerous!}}" Harry's voice didn't quite rise to a shriek, he couldn't
...
"And while I hate to get all \emph{\shout{philosophical,}}" Harry desperately tried to
lower his voice to something under a shriek, "has anyone thought about the
\emph{\shout{implications}} of going back six hours and doing something that changes
time which would pretty much \emph{\shout{delete all the people affected}} and \emph{
\shout{replace them with different versions}}\mbox{---}"
...
\emph{\shout{%
    ...
    and what idiot ever built one of these things for the first time?"
}}
...
"Turning into a cat doesn't even \emph{\shout{begin}} to compare to this. You know
...
that is ruled out} because this little toy \emph{\shout{isn't turing computable!}} A
...
"\emph{\shout{So that's how the comed-tea works!}} Of \emph{course!} The spell doesn't
...
be acyclic \shout{but it all makes sense once you draw the causal arrows going
...
\begin{writtenNote}
    ...
    power to keep you \emph{hidden}, not merely invisible. Your father lent it
    ...
    history from repeating, but be \secondemph{most} careful not to reveal yourself. If
