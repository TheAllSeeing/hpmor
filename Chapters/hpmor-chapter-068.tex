...
over some silly little game but\mbox{---}
...
afterward had washed her face in hopes it wouldn't show\mbox{---}
...
The girl started to explain\mbox{---}
\sbreak
...
it suddenly occurred to Hermione that this might be the \emph{original}\mbox{---}
