...
complete disaster. If Mr.~Goyle had managed to disrupt both Transfigurations\mbox{---}
\sbreak
...
"Anything else?" said Draco. If that was it, they'd lost a broom for nothing\mbox{---}
...
to deduce the required stirring pattern\mbox{---}
...
others shouting \emph{"Somnium!"}\mbox{---}
...
her own army; staring at him with a look of fury\mbox{---}
...
be described as, indeed, "chaotic"\mbox{---}
...
almost everyone else stopping to gape\mbox{---}
...
uttered, \shout{"doom doom doom doom doom"}, because you just couldn't see that and
...
billowing high around them\mbox{---}
...
at where she thought Neville's thighs would be \emph{after} he dodged\mbox{---}
...
a second to scramble to her feet and get both hands around her wand again\mbox{---}
\sbreak
...
and Hannah was moving in to fire a real spell almost point-blank\mbox{---}
...
for her with his other hand\mbox{---}
...
remembering which side she was on\mbox{---}
...
From behind Daphne, a small gasping voice said, "I---can---still---fight\mbox{---}"
...
casualties! End truce! \shout{Tunafish!}"}
...
like the Sun magnified a dozen times\mbox{---}
...
\sbreak
\shout{"Now!"} bellowed Blaise Zabini, formerly of Sunshine, now commanding a
detachment of Chaos Legionnaires. "I mean, \shout{Tunafish!}" The Slytherin boy's hand
grasped the cloth shielding the cauldron from the triggering touch of daylight,
already beginning to move it aside.

\shout{"Now!"} bellowed Dean Thomas, formerly of Chaos, commanding a consignment of
Dragon Warriors. \shout{"Do whatever they do!"}

The Chaotics of Zabini's detachment plunged their hands into their uniform
pockets, and came forth bearing green sunglasses\mbox{---}
...
\shout{"Finite their goggles!"} shouted Blaise Zabini, as the two armies ran headlong
toward each other through omnipresent eye-searing purple glare. \shout{"We can still
win!"}
...
either, all he could do was whip his left hand into position and hope\mbox{---}
...
\emph{she} thought he was secretly plotting against her\mbox{---}
...
found something he could actually cast at her\mbox{---}\emph{"\shout{Densaugeo!}"}
...
voice rose to a shriek audible across the whole battleground\mbox{---}

\emph{"\shout{Alohomora!}"}
...
elevated bleachers, moving in eerie unison like an Auror trio\mbox{---}
...
The padlock on his glove clicking and falling away\mbox{---}
...
\emph{Granger whirled and spun and screamed \shout{`Alohomora!'}}\mbox{---}
...
many times. Prove that the Malfoy blood was stronger than any Mudblood's\mbox{---}
...
\uline{falsely} accused me of plotting against you,
\end{writtenNote}
...
Great Hall and the students whispering over their breakfasts, he pointed\mbox{---}
