...
would see through the Shadow's plans and devise an irresistible counterstroke\mbox{---}
...
\sbreak%
\auTitle{Celestia.ttf}{My Little Pony: Friendship is Science}{1.6}
...
Nightmare wouldn't just stand there and let them do it\mbox{---}
...
rule over.}
\sbreak%
\auTitle{NinjaNaruto}{The Village Hidden in the Clarity}{1.6}
...
%% \auTitle{}{\MakeUppercase{Erdős in Chains}}{1.5}
...
\auTitle{Thundercats}{ThunderSmarts}{2}
...
\auTitle{OldSchoolUnited}{He-Man and the Masters of Rationality}{1.6}
...
\auTitle{Times New Roman}{Fate/Sane Night}{1.6}
\begin{center}
  { \em
...
%% \auTitle{}{The Name of the Rationality}{1.6}
...
But no sooner the brim of the ancient felted device slipped over his forehead\mbox{---}
...
\auTitle{Twilight}{Utilitarian Twilight}{1.5}
...
him, but it would disable him for long enough\mbox{---}
\sbreak%
\vspace{-2\baselineskip}
\auTitle{Aladdin}{\sout{Aladdin} Jasmine}{1.6}
...
\sbreak%
\vspace{-2\baselineskip}
\auTitle{Hamlet.otf}{Prince Hamlet and the Philosopher's Stone}{1.6}
\noindent{}HAMLET\\
...
get on with my life."
\sbreak%
\auTitle{AliceInWonderland}{Alice In The Land Where Things Are Even Crazier Than Here}{1.6}
...
\auTitle{Matrix}{Welcome to the Real World}{1.6}
...
intravenously to the living\mbox{---}
