...
So much exhaustion and hurt in Harry Potter's voice\mbox{---}
...
you nothing, then. I see." Snape gave a snort, turned away\mbox{---}
...
the Ravenclaw table, and Draco\mbox{---}

---gave Harry one quick look\mbox{---}
...
Draco paused for a moment, weighing, and then opened his mouth\mbox{---}
...
ears \emph{recognized} this one\mbox{---}
...
just---hadn't \emph{thought} of it\mbox{---}
...
and then Ron Weasley said loudly, "Get in line, you lot, I got an owl from Mom
...
she's kidding\mbox{---}" and Ron reached over to a plate and hefted a muffin\mbox{---}
...
would have had trouble speaking too\mbox{---}
...
ancient and \emph{very} powerful and he was giving the two of them a \doubleemph{sharp look.}
...
exchanged uncertain looks with each other\mbox{---}
...
they turn into \mentalscream{big} mistakes?}

{\el} although this already seemed to qualify as a \mentalscream{big} mistake,
actually{\el}
...
sin, and then they use \secondemph{that} sin to make them do even bigger things and then the
...
did come after him later, that war might already be lost\mbox{---}
...
\emph{Hold on, \secondemph{that's not fair---}}
...
loudly Mom would scream if she'd heard you'd been elected Prime Minister, now
...
Professor McGonagall, Professor Flitwick, Hermione, Draco, not to mention Mom
...
she stopped halfway out of her chair\mbox{---}
...
\emph{"\shout{Don't go!}"} The voice came in a scream from behind the metal door. \emph{"No,
...
Fawkes should hate everyone\mbox{---}
...
had to do something, \emph{had to do something, had to \mentalscream{do something---}}
