...
Harry sat up and looked around, expecting to see others rising for the day\mbox{---}
...
\begin{gameNote}
    \MakeUppercase{Instructions for The Game:}
...
around \doubleemph{{While you were still on them.}}
...
\secondemph{not} going to ask the painting whether it was fully conscious in the sense of
...
\begin{gameNote}
  \begin{gameNoteText}
    \emph{Warning}\\
    \emph{No} magic may be used on the contestant\\
    while The Game is in progress\\
    Further interference in The Game\\
    \emph{will} be reported to the Game Authorities
  \end{gameNoteText}
\end{gameNote}
...
\emph{\secondemph{What the heck am I doing?}}
...
would never let something like this \emph{actually} happen\mbox{---}
...
\emph{Uh oh. That's right, it was \secondemph{her} class I missed this morning.}
...
\begin{gameNote}
    \begin{gameNoteText}
        ...
        \emph{You have lost the game}
    \end{gameNoteText}

    Final instruction:\\

    \normalfont\textit{go to Professor McGonagall's office}
\end{gameNote}
