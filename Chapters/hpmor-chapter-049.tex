...
did the \emph{actual ordering}---and it would be awkward if he protested now\mbox{---}

The waitress bowed to them, and turned to go\mbox{---}
...
And Harry took a casual sip of his water\mbox{---}
...
gotten the impression that nobody knew anything\mbox{---}
...
could create a long-lived enough sentient creature with a good enough memory\mbox{---}
...
growing collection of secrets. Then\mbox{---}
...
\parseltounge{greetingss.}"

\parseltounge{"Sso,"} hissed the snake. \parseltounge{"You sspeak, I hear. I sspeak, you hear?"}

\parseltounge{"Yess, I hear,"} hissed Harry. \parseltounge{"You are an Animaguss?"}

\parseltounge{"Obvioussly,"} hissed the snake. \parseltounge{"Thirty-sseven ruless, number
...
black pupils in dark grey fields. \parseltounge{"This iss mosst ssecure way to sspeak.
You ssee? No otherss undersstand uss."}

\parseltounge{"Even if they are ssnake Animagi?"}

\parseltounge{"Not unlesss heir of Sslytherin willss."} The snake gave a series of
short hisses which Harry's brain translated as sardonic laughter.
\parseltounge{"Sslytherin not sstupid. Ssnake Animaguss not ssame as Parsselmouth.
Would be huge flaw in sscheme."}

Well \emph{that} definitely argued that Parseltongue was personal magic, not
snakes being sentient beings with a learnable language\mbox{---}

\parseltounge{"I am not regisstered,"} hissed the snake. The dark pits of its eyes
stared at Harry. \parseltounge{"Animaguss musst be regisstered. Penalty is two yearss
imprissonment. Will you keep my ssecret, boy?"}

\parseltounge{"Yess,"} hissed Harry. \parseltounge{"Would never break promisse."}

The snake seemed to hold still, as though in shock, and then began to sway
again. \parseltounge{"We come here next in sseven dayss. Bring cloak to passs unsseen,
bring hourglasss to move through time\mbox{---}"}

\parseltounge{"You know?"} hissed Harry in shock. \parseltounge{"How\mbox{---}"}

Again the series of short quick hisses that translated as sardonic laughter.
\parseltounge{"You arrive in my firsst classs while sstill in other classs, sstrike
down enemy with pie, two ballss of memory\mbox{---}"}

\parseltounge{"Never mind,"} hissed Harry. \parseltounge{"Sstupid question, forgot you were
ssmart."}

\parseltounge{"Foolissh thing to forget,"} said the snake, but the hiss did not seem
offended.

\parseltounge{"Hourglasss is resstricted,"} Harry said. \parseltounge{"Cannot usse until ninth
hour."}

The snake twitched its head, a snakish nod. \parseltounge{"Many resstrictionss. Locked
...
\parseltounge{"Ansswer in sspeech."}

\parseltounge{"Yess."}

\parseltounge{"Will do as I ssaid?"}

\parseltounge{"Yess. But,"} Harry gave a wobbling rasp that was how his mind had
translated a hesitant `Ahhh' into snakish, \parseltounge{"I do not promisse to do
whatever thiss iss, you have not ssaid\mbox{---}"}

The snake performed a shiver that Harry's mind translated as a severe glare.
\parseltounge{"Of coursse not. Will disscusss sspecificss at next meeting."}
