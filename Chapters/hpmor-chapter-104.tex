...
she swerves in midair to avoid---\shout{is that the snitch? Go, Cho Chang, go, Higgs
is already---what are you two doing?}"

"Calm down, Mr.~Jordan!"

"\shout{How am I supposed to calm down? that was the worst missed play i've ever seen!}
...
The approaching footsteps rounded the corner\mbox{---}
...
there's not much point keeping it mom any longer," she said, "since I'm
...
\emph{One more minute can't make the difference he's had the \secondemph{whole year} to be
sick it's \secondemph{improbable} that his life versus death would be precisely timed to
...
just been trying to drop not-Susan so he could get into the corridor unhindered\mbox{---}
...
the world that could save the Defense Professor's life\mbox{---}
...
the same time as Professor Quirrell\mbox{---}
...
Harry himself might have tried to bypass all of a target's protections\mbox{---}
...
was Avada Kedavra and and and\mbox{---}
