...
Professor Quirrell finished his Charms\mbox{---}

---stood up from his chair\mbox{---}

---blurred into a green snake, banded in blue and white\mbox{---}

---hissed, \parseltounge{"Hungry, boy? Eat your fill sswiftly, we sshall need both
sstrength and time."}

Harry's eyes were a bit wide, but he hissed, \parseltounge{"I ate well at breakfasst,"}
...
\parseltounge{"Do not wissh to explain here. Prefer to be elssewhere firsst. Need to
leave unobsserved, without ssign we have ever departed room."}

\parseltounge{"Sso no one can track uss,"} hissed Harry.

\parseltounge{"Yess. Do you trusst me that much, boy? Think before ansswer. I will have
...
\parseltounge{"I trusst you,"} hissed Harry.
...
innocent was the one who hadn't gotten a trial\mbox{---}
