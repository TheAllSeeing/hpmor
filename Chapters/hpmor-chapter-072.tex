...
at her---the way the \emph{Slytherins} had been looking at her\mbox{---}
...
artifacts to \emph{anyone} he considered a friend, but\mbox{---}
...
herself, and then tried to sign something else that Susan didn't understand\mbox{---}
...
anything. For a moment Susan felt an instant of relief\mbox{---}
...
couldn't get in even a single shot\mbox{---}
...
been buzzing with speculation about Salazar Slytherin's ghost, yesterday\mbox{---}

\emph{He's expecting us!}

Susan would have whispered to give up, to abort the plan, only there was no way
to convey a message to\mbox{---}
...
the bully wouldn't expect it, that had been the plan, only now\mbox{---}
...
of the dangling fourth-year boy, drew back his fist\mbox{---}
...
Tracey and Lavender screamed at the same time, "\emph{Wingardium Leviosa!}"\mbox{---}
\sbreak
...
passageway with all the speed she could muster, weaving as much as she could\mbox{---}
...
There was a flash that lit up the whole corridor\mbox{---}
\sbreak
...
recast his Shielding Charm\mbox{---}
...
shrieking at the top of her lungs about blatant stupidity and \mentalscream{doom} would be
...
Professor Snape was looking directly at\mbox{---}
...
bounced off a student's back and collapsed onto the ground\mbox{---}
...
stopped abruptly, halfway to his feet, as if he'd just thought of something\mbox{---}
...
it would be too late, \emph{why wasn't the Headmaster doing anything}\mbox{---}
...
like he hadn't---he hadn't just---\emph{he'd just}\mbox{---}
...
during which it couldn't think of anything to say except the truth\mbox{---}
...
"He\mbox{---}" Hermione said falteringly. She remembered the rooftop, the awful jolt
