...
\emph{{\el} convince Professor Quirrell to \mentalscream{stop this{\el}}}
...
Professor Quirrell was smiling evilly. \parseltounge{"Your guesss iss right, boy, for
...
\parseltounge{"Tell me, teacher,"} Harry hissed, \parseltounge{"would desstroying thosse five
anchors sslay you?"}

\parseltounge{"Why do you assk?"} hissed the Defense Professor, with a lilt to the hiss
that Parseltongue translated as snakish amusement. \parseltounge{"Do you ssusspect that
ansswer is no?"}

Harry couldn't think of how to answer, though he strongly suspected that it
didn't matter in any case.

\parseltounge{"Your ssusspicion iss right, boy. Desstroying thosse five would not
render me mortal."}

Harry's throat felt a bit dry again. If the spell had no disastrous cost
associated with it{\el} \parseltounge{"How many anchorss did you make?"}

\parseltounge{"Would not ordinarily ssay, but iss clear you have already guesssed."}
The Defense Professor's smile widened. \parseltounge{"Ansswer iss that I do not know.
...
\parseltounge{"Great creation maintainss life and magic within devicess created by
ssacrificing life and magic of otherss."} Again that hissing snake laughter.
\parseltounge{"Liked falsse desscription of previousss Horcrux sspell sso much, sso
...
\parseltounge{"Yess. I sshall return sswiftly, if thiss body iss killed. Will be
...
the rectitude that wizardborns absorb in childhood. \parseltounge{And all thiss that I
...
\parseltounge{"None of it iss known to me to be falsse,"} said Professor Quirrell.
"Telling a tale implies filling in certain gaps; I was not present to observe
when Perenelle seduced Baba Yaga. \parseltounge{The bassicss sshould be mosstly
correct, I think.}"
...
parchment from within his robes, hissed at it \parseltounge{"Sshow our
...
another thing to find that Hogwarts's magic agreed. \parseltounge{"Did you tamper with
thiss map to achieve thiss ressult, or did it appear before you by ssurprisse?"}

\parseltounge{"Wass ssurprisse,"} replied Professor Quirrell, with an overtone of
hissing laughter. \parseltounge{"No trickss."}
...
\parseltounge{"Not sso far ass I know,"} hissed Harry.

"Fascinating," said Professor Quirrell. "You may be interested to know this as
well: \parseltounge{Potionss-maker had to work in ssecret because hiss plot oppossed
...
sabotaging Slytherin House---don't give me that look, boy, \parseltounge{I am sspeaking
...
\parseltounge{"Ssent her to a peaceful place to recover sstrength"}, Professor Quirrell
...
it. \parseltounge{Wass no malice in it, only hopess that you would recover ssome of
...
had scheduled for shortly after. \parseltounge{Alsso no malice there.} I arranged some
of the attacks on Miss Granger's group, so that the attacks could be defeated;
I do rather dislike bullies. \parseltounge{Think that iss all ssecret plotss concerning
...
\parseltounge{"Not valuess difference. True misstake, given your goalss. Will you hurt
...
\parseltounge{"No,"} hissed Professor Quirrell. \parseltounge{"Not if lessson iss true."}
...
Harry swallowed a lump in his throat. "\parseltounge{There wass way for you to tesst
...
\emph{had to be something} if he could just find the right thing to say\mbox{---}
