...
Harry spun around to look\mbox{---}
...
And Hermione gave a tiny, pathetic shriek, flinched\mbox{---}
...
\secondemph{\mentalscream{fear / cold / darkness}}
...
began to slide sideways, into bitterness, black fury, deathly hatred\mbox{---}
...
image of Hermione came to him, or an image of Mom and Dad, the Dementor twisted
...
as they locked to his own\mbox{---}
\end{em}
\sbreak
...
at Harry's convulsing body in horror\mbox{---}
...
everything; she'd seen Harry dying, Mom and Dad dying, all her friends dying,
...
\emph{"\shout{Flitwick!}}" roared Professor Quirrell. "\emph{\shout{Summon potter's wand!}"}
