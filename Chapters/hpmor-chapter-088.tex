...
and Vector were eating in their usual grouping, and\mbox{---}
...
student had said, trolls weren't \emph{silent} predators, they were noisy\mbox{---}
...
"\emph{\shout{Quiet! Everyone! Shut up!}}"
...
lip-moving noises he'd been \emph{distracted}\mbox{---}
...
then because Harry was past him and\mbox{---}
...
the ground and having almost no room to maneuver and then\mbox{---}
...
him from the troll, and that would free up a seat for Hermione\mbox{---}
...
straight West Corridor instead\mbox{---}
...
to be given a set of those neat little mirrors the Aurors used to communicate\mbox{---}
...
voice became higher-pitched, "\emph{\shout{ahhhhhhhhh!}}"
...
maximum speed, only Harry didn't \emph{know where}\mbox{---}
...
marble open to the air and sky\mbox{---}
