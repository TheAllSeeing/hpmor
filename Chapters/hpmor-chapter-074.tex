...
had almost immediately begun to form around it\mbox{---}
...
bolts that lit the wide corridor brighter than the Sun\mbox{---}
...
"\emph{Nurgolth!}", and then, to her right, "\emph{\shout{Tzintchi!}}"
...
"\emph{Well what happens if it gets \secondemph{completed?}}" screamed Hermione, as close as
...
\shout{Harry James Potter-Evans-Verres!}}"

There was a snap like thunder, and then\mbox{---}
\sbreak
...
normal. People stared at her, and said nothing\mbox{---}
...
There was a very slight pause\mbox{---}
...
wringing her hands and tears starting from her eyes\mbox{---}
