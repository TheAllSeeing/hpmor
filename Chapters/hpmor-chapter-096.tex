...
world except Harry. If someone had undone their death\mbox{---}
...
even now nobody knew \emph{why}\mbox{---}
...
\ifnum\hpBookType=0 % On ebook preventing mbox will stretch byond margin as neccessary
    \makebox[\textwidth]{Three shall be Peverell's sons and three their devices by which Death shall be
    defeated.}
\else % On print stretching beyond margins may be dangerous (and some text may not actually be printed), so I just linebreak at a good spot
    Three shall be Peverell's sons \\
